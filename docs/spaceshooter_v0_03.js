...
// Textures
// ##########################################
var enemyTexture1 = new PIXI.Texture.fromImage(URL + "img/alien.png");
var enemyTexture2 = new PIXI.Texture.fromImage(URL + "img/alien2.png");
var bulletTexture = new PIXI.Texture.fromImage(URL + "img/small_laser.png");
...
// Sound
// ##########################################
var upgrade = new  Howl({
	urls: [URL + 'audio/upgrade.mp3'],
	volume: 0.5,
});
var release = new  Howl({
	urls: ['audio/release.mp3'],
	volume: 0.5,
});
...
var bg = PIXI.Texture.fromImage(URL + "img/bg_tile.png");
...
function PlayerBall(playerCurrentPositionX, playerCurrentPositionY) {
	...
	this.object = new PIXI.Sprite(PIXI.Texture.fromImage(URL + "img/ball.png"));
...
function Player() {
	...
	if (random <= 3) {
		plane = new PIXI.Sprite(PIXI.Texture.fromImage(URL + "img/spaceship.png"));
		plane.height = 50;
		plane.width = 50;
	}
	else if (random <= 6) {
		plane = new PIXI.Sprite(PIXI.Texture.fromImage(URL + "img/spaceship2.png"));
		plane.height = 50;
		plane.width = 50;
	}
	else {
		plane = new PIXI.Sprite(PIXI.Texture.fromImage(URL + "img/spaceship3.png"));
		plane.height = 50;
		plane.width = 50;
	}
